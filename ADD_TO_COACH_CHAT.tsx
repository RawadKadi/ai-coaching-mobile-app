/**
 * ADD THIS TO app/(coach)/chat/[id].tsx
 * 
 * Step 1: Add component after line 697 (after TaskCompletionMessage)
 */
...
const ChallengeCompletionMessage = ({ content, isOwn }: { content: any, isOwn: boolean }) => {
  ...
  return (
    <View style={[challengeStyles.container, { alignSelf: isOwn ? 'flex-end' : 'flex-start' }]}>
...
/**
 * Step 2: Add rendering logic around line 1425
 * 
 * Find this section and ADD the challenge_completed case:
 */
