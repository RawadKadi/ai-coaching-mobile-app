...
import { View, Text, ScrollView, TouchableOpacity, TextInput, ActivityIndicator, StatusBar, Alert, Dimensions, StyleSheet, PanResponder } from 'react-native';
  ...
  const renderMetrics = () => (
    ...
    >
      ...
      <TouchableOpacity 
        ...
        className="bg-blue-600 h-20 rounded-[32px] items-center justify-center flex-row gap-3 mb-10 shadow-2xl shadow-blue-500/30"
      >
...
const SliderInput = ({ label, value, min, max, onChange, icon, color }: any) => {
  ...
  return (
    <View>
      ...
      >
        <View className="h-4 bg-slate-900 rounded-full justify-center px-1 border border-white/5 overflow-hidden">
          <MotiView 
      ...
      <View className="flex-row justify-between mt-3 px-1">
        <Text className="text-slate-700 text-[10px] font-black uppercase">Low</Text>
        <Text className="text-slate-700 text-[10px] font-black uppercase">Peak</Text>
      </View>
    </View>
  );
};
