...
-- Recreate the correct use_invite_code function without updated_at for coach_client_links
...
BEGIN
  ...
  INSERT INTO coach_client_links (coach_id, client_id, status, created_at, assigned_at)
  VALUES (v_invite.coach_id, p_client_id, 'active', NOW(), NOW())
