...
export default function StrandsBackground(props: StrandsProps) {
  const { primary: brandColor } = useBrandColors();
  const {
    colors = [brandColor, '#2563EB', '#60A5FA', '#10B981'],
    count = 3,
    speed = 0.5,
    amplitude = 1,
    waviness = 1,
...
<head>
  ...
  <style>
    ...
    #ctn { width: 100%; height: 100%; position: absolute; top: 0; left: 0; }
  </style>
</head>
<body>
  <div id="ctn"></div>
  <script type="module">
    import { Renderer, Program, Mesh, Color, Triangle, RenderTarget } from 'https://cdn.jsdelivr.net/npm/ogl@0.0.117/src/Core.js';
    ...
    const program = new Program(gl, {
      ...
      uniforms: {
        ...
        uColors: { value: buildPalette(currentColors) },
        uColorCount: { value: Math.min(currentColors.length, MAX_COLORS) },
